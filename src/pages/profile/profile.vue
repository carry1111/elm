<template>
  <div class="profile">
      ...
      <section class="maininfo clearfix">
          <div class="hongbao">
              <span class="num">
                  <span class="zero">0</span>个
              </span>
